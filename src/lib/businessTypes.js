...
export const BUSINESS_TYPES = {
  TRANSIT: {
    ...
    color: '#4f8ef7',
    category: 'LOGISTICS',
    navItems: ['transit', 'reservations', 'checkin'],
  ...
  RESTAURANT: {
    ...
    navItems: ['reservations', 'checkin', 'tables'],
    description: 'Manage reservations, table availability, and guest check-ins',
  },
  HOTEL: {
    label: 'Hotel',
    icon: 'Building2',
    ...
    navItems: ['reservations', 'checkin', 'rooms'],
    description: 'Manage room bookings, availability, and guest check-ins',
  },
  RETAIL: {
    label: 'Retail',
    icon: 'ShoppingBag',
